...
static void Take_Task(void* pvParameters);/* Receive_Task任务实现 */
static void Give_Task(void* pvParameters);/* Send_Task任务实现 */
...
static void AppTaskCreate(void)
{
  ...
  /* 创建 BinarySem */
  CountSem_Handle = xSemaphoreCreateCounting(5,5);/* 创建计数信号量，最大为5，起始为5 */
